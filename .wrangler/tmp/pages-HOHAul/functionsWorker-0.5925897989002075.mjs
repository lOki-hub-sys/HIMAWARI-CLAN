...
// ../../../home/codespace/.npm/_npx/32026684e21afda6/node_modules/unenv/dist/runtime/node/console.mjs
import { Writable } from "node:stream";

// ../../../home/codespace/.npm/_npx/32026684e21afda6/node_modules/unenv/dist/runtime/mock/noop.mjs
...
// ../../../home/codespace/.npm/_npx/32026684e21afda6/node_modules/@cloudflare/unenv-preset/dist/runtime/node/console.mjs
...
// ../../../home/codespace/.npm/_npx/32026684e21afda6/node_modules/wrangler/_virtual_unenv_global_polyfill-@cloudflare-unenv-preset-node-console
...
async function onRequestPost(context2) {
  const { DB } = context2.env;
  try {
    const { title: title2, body, category } = await context2.request.json();
    if (!title2 || !body) {
    ...
    ).bind(title2, body, category || "ANNOUNCEMENT").run();
...
async function onRequestPost2(context2) {
  ...
  try {
    ...
    const { id, title: title2, bracket_data, published_to_home } = body;
    if (!title2 || !bracket_data) {
    ...
    if (id) {
      await DB.prepare(
        `UPDATE brackets 
         ...
         WHERE id = ?`
      ).bind(title2, jsonString, isPublished, id).run();
    } else {
      await DB.prepare(
        `INSERT INTO brackets (title, bracket_data, published_to_home) 
         VALUES (?, ?, ?)`
      ).bind(title2, jsonString, isPublished).run();
    }
...
// ../.wrangler/tmp/pages-HOHAul/functionsRoutes-0.6175845952292348.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-gqGeUE/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-gqGeUE/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.5925897989002075.mjs.map
